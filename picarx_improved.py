...
try:
    ...
    print("This computer does not appear to be a PiCar-X system. Shadowing hardware calls with substitute functions")
...
# @param differential - set to false if differential on powered motors is not desired.
def forward(speed, angle, differential=True):
    length = 9.5 # cm
    width = 11.7 # cm
    ...
    set_motor_speed(1, -1*L)
    set_motor_speed(2, -1*R)
